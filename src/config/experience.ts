import { TimelineItemType } from "../components/Timeline";

export const experienceTimelineItems: Array<TimelineItemType> = [
    {
    ...
    },
    {
        ...
        employer: 'Conestoga College Applied Research',
        description: 'Member of a Cyber-Security Research Team for an ongoing IoT development project. Carried out\n' +
            'exhaustive penetration tests against servers to ensure all data and communications were\n' +
            'protected and impenetrable. Created and maintained a web application for the company to\n' +
            'continuously view and monitor their system’s security status. Generated documentation for the\n' +
